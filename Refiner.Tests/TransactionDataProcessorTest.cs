...
namespace Refiner.Tests
{
    ...
    {
        [Test]
        public void CanExtractDataArray()
        {
            // Positive cases
            string jsonInputCase = "{data:[{\"hello\" : 1}]}";
